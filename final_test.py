...
def generate_timeline_text(csv_path):
    print("Reading CSV and compressing timeline...")
...
def ask_phi3(timeline_context, user_question):
    print("\nAnalyzing timeline and generating formatted response...\n")
    ...
    TEMPLATE:
    Query: "{user_question}"
    Answer: [Provide a concise direct answer, e.g., Yes, Walking, 700 seconds]
...
if __name__ == "__main__":
    ...
    # You can change this query to match whatever the judges ask!
